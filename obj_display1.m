function handle = obj_display1 ( input_file_name )
...
if(exist('input_file_name','var')==0)
    [filename, filefolder] = uigetfile('*.obj', 'Read obj-file');
    input_file_name = [filefolder filename];
end
% filefolder = fileparts( input_file_name);
% if(verbose),disp(['Reading Object file : ' input_file_name]); end
